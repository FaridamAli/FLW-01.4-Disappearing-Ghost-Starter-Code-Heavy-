...
ghostImg.src="https://i.etsystatic.com/21833184/r/il/f6dc00/2462058844/il_570xN.2462058844_6d3w.jpg"
});
...
messageButton.onclick = (function(){
  ...
  message.insertAdjacentHTML('beforeEnd',userInput.value);
});
...
nameButton.onclick = (function(){
    userInput= document.querySelector(".input")
  h1.innerHTML = `<p> ${userInput.value}!</p>`;
});